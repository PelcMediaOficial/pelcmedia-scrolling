...
var banner = ['/*!\n',
  ' * PelcMedia - <%= pkg.title %> v<%= pkg.version %> (<%= pkg.homepage %>)\n',
  ' * Copyright 2018-' + (new Date()).getFullYear(), ' <%= pkg.author %>\n',
  ' * Licensed under <%= pkg.license %> (https://github.com/PelcMediaOficial/<%= pkg.name %>/LICENSE)\n',
  ' */\n',
  '\n'
].join('');
...
gulp.task('vendor', function() {
  ...
  .pipe(gulp.dest('./public/vendor/holderjs'))
